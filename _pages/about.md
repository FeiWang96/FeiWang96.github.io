...
My research interests lie in natural language processing (NLP) and machine learning (ML). My recent work is centered around developing **robust and controllable (multimodal) LLMs**, with a special focus on enhancing their reliability and generalizablity in the alignment and inference processes.
